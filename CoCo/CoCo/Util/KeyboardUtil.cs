...
namespace KeyboardUtil
{
    ...
    public class Event
    {
        ...
        private static extern void keybd_event(int Vk, byte bScan, int Wm, uint dwExtraInfo);

        public static void Send( VKey key, int msg )
        {
            keybd_event((int)key, 0, msg, 0);
        }
    }
}